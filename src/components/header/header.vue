  ...
  <div class="header">
  	<header id="header-wrap">
  		<ul>
  	  	...
  	  	<div class="top-bar">
  		    <div class="bar-wrap">
  		      <div class="chicken"><img src="./chicken.gif" alt=""></div>
  		      <div class="top-title">
  		        <h2>orca</h2>
  		        <span>逆戟 · 个人网站</span>
  		      </div>
  		        ...
  		        <div class="nav-wrap">
  		          <nav>
  		            ...
  		            <ul>
  		              ...
  		              <li><a href="#foot">履历</a></li>
  		              <li><a href="#writing">作品</a></li>
  		              <li><a href="/">博客</a></li>
...
#header-wrap>ul>li:nth-of-type(3){
  background: #efd21f;
}
#header-wrap>ul>li:nth-of-type(4){
  background: #aec534;
}
#header-wrap>ul>li:nth-of-type(5){
  background: #24a5db;
}
#header-wrap>ul>li:nth-of-type(6){
  background: #5830cb;
}
.head-me{
  float: right;
